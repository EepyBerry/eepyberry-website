        ...
        <ul class="info-list">
          <li>
            ...
            >
              ...
              />
              <span
                v-if="isSelected('info', 0)"
                class="selection-notch down"
              ></span>
            </button>
          </li>
          <li>
        ...
        <ul class="info-list">
          <li>
            ...
            >
              <iconify-icon
                mode="svg"
                icon="noto:woman-technologist"
                height="1.75rem"
                aria-hidden="true"
              />
              <span
                class="selection-notch up"
                v-if="isSelected('interest', 0)"
              ></span>
            </button>
          </li>
          <li>
          ...
          <li>
            ...
            >
              <iconify-icon
                mode="svg"
                icon="noto:teddy-bear"
                height="1.75rem"
                aria-hidden="true"
              />
              <span
                class="selection-notch up"
                v-if="isSelected('interest', 7)"
              ></span>
            </button>
          </li>
        </ul>
